 	...
 	} else 
 	{
 		...
 		<div class="top-header">
 			<div  class="container">
 				...
 				<ul styles= fontsize 100px, class="tp-hd-rgt wow fadeInRight animated" data-wow-delay=".5s"> 
 					<li class="tol">Tell Number : 0717350266</li>        
 	...
 	<div class="container">
 		<nav class="navbar navbar-inverse" role="navigation">
 			<div class="navbar-header adeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">
 				<a href="#" class="navbar-brand scroll-top logo"><b>Tour Guide System</b></a>
