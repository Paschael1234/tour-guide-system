...
<section id="introText">
  <div class="container">
    <div class="text-center adeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">
      <h1>My Tours Gives You a Great Holiday Package</h1>
      <p>let's enjoy the adventure by touring world wide </p>
    </div>
  </div>
</section>
<!--About-->
<section id="aboutUs" class="secPad">
  <div class="container">
    ...
    <div class="heading text-center adeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">
      <!-- Heading -->
      <h2>About Us</h2>
      <p>Tour guide system is readily accessible, yet most instances have undergone modification in some way through the addition of humor.</p>
    </div>
    <div class="row adeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">
      <div class="col-md-4">
        <img src="images/aboujpgt." alt="" class="img-responsive img-thumbnail">
      </div>
      <div class="col-md-8">
        <p>Pleasure isn't rejected for itself but for the painful consequences of irrational pursuit. Pain isn't pursued, but endured for the prospect of greater pleasure. </p> 
        <p>Pleasure isn't rejected for itself but for the painful consequences of irrational pursuit. Pain isn't pursued, but endured for the prospect of greater pleasure. </p> 
        <p>Pleasure isn't rejected for itself but for the painful consequences of irrational pursuit. Pain isn't pursued, but endured for the prospect of greater pleasure. </p> 
      </div>
    </div>
...
<section id="packages" class="secPad">
  <div class="container">
    <div class="heading text-center">
      ...
      <p>Happiness in booking favourable tour packages</p>
    </div>
    <div class="">
      <h3>Package List</h3>
...
<section id="portfolio" class="page-section section appear clearfix secPad">
  <div class="container">
    <div class="heading text-center">
      <!-- Heading -->
      <h2>Gallery</h2>
      <p>Tour guide system gallery pictures</p>
    </div>
    <div class="row">            
      <div class="col-md-12">
        <div class="row">
  ...
  <div class="container">
    ...
    <div class="row mrgn30">
      ...
      <div class="col-sm-12 col-md-4">
        <h4>Address:</h4>
        <address>
          Tour Guide Company<br>
          Salama, street<br>
          Luthuli Avenue, Kenya
          <br>
        </address>
        <h4>Phone:</h4>
        <address>
